...
> **Note**: This code is based on the content on the lecture notes published on 
...
**Note**: - To add a `code chunk`, you can use the keyboard shortcut , but it depends on which mode you are in:
...
flights_df |>
  ...
  labs(
    x = "Month",
    y = "# of Flights",
    title = "# of Flights by Month in New York"
  ) +
  theme_bw()
```
